...
const Mid = () => {
  ...
  const [Icons, setIcons] = useState([
    { id: 1, imageurl: "/images/icon_index_nature.svg", backgroundColor: "#25BD69", iconText: "자연" },
    { id: 2, imageurl: "/images/icon_index_safe.svg", backgroundColor: "#FCC913", iconText: "안전" },
    { id: 3, imageurl: "/images/icon_index_edu.svg", backgroundColor: "#4DB4FF", iconText: "교육" },
    { id: 4, imageurl: "/images/icon_index_life.svg", backgroundColor: "#FFA133", iconText: "생활편의교통" },
    { id: 5, imageurl: "/images/icon_index_weal.svg", backgroundColor: "#F77373", iconText: "복지문화" },
]);
  ...
  return (
    <>
      <div className="flex pt-5 align-middle">
        <div className="flex text-black font-bold text-sm">라이프스타일 선택</div>
      ...
      <div>
            ...
            <div className="index-select">
                <ul className="index-select__selected flex flex-row flex-wrap border border-solid border-gray-300 rounded-lg p-0 pb-15">
                <MetrixIcon
      ...
      <div className="button-wrap flex w-full">
        <button
          type="button"
          ...
          onClick="$houseMap.function.initSimpleLayer();"
        >
          <img src="/images/redo-24.png" className="w-4 h-4 mr-1" alt="icon" />
          <span style={{color:"#606060", fontSize:"15px", fontWeight:600}}>초기화</span>
        </button>
        <button
          type="button"
        ...
        >
          <span style={{color:"white", fontSize:"15px", fontWeight:600}}>분석</span>
        </button>
      </div>
    </>
  );
